...
def get_arg():
    ...
    # parser.add_argument('--exp_dir', type=str, default='./log/ped2_4', help='directory of log')
...
class Runner(object):
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            for j, (imgs) in enumerate(self.train_batch):
    ...
    def test(self, epoch=-1):
        ...
        for k, (imgs) in enumerate(self.test_batch):
            if self.args.method == 'pred':
